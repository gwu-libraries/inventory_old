...
urlpatterns += patterns('invapp.views',
    ...
    url(r'^bag/(?P<bag_id>.*)$', 'bag', name='bag'),
    ...
    url(r'^ajax/collection_items_autocomplete/(?P<collection>\w{5}/\w{10,12})$', 'collection_items_autocomplete', name='collection_items_autocomplete'),
    url(r'^ajax/search_collection_autocomplete/$', 'search_collection_autocomplete', name='search_collection_autocomplete'),
    url(r'^ajax/project_items_autocomplete/(?P<project>\w{5}/\w{10,12})$', 'project_items_autocomplete', name='project_items_autocomplete'),
