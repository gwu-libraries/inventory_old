...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.access_root'
        db.add_column(u'invapp_machine', 'access_root',
                      self.gf('django.db.models.fields.FilePathField')(default='/', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.access_root'
        db.delete_column(u'invapp_machine', 'access_root')
