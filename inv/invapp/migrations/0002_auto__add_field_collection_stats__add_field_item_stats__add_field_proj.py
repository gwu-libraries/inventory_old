...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.stats'
        db.add_column('invapp_collection', 'stats',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)

        # Adding field 'Item.stats'
        db.add_column('invapp_item', 'stats',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)

        # Adding field 'Project.stats'
        db.add_column('invapp_project', 'stats',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.stats'
        db.delete_column('invapp_collection', 'stats')

        # Deleting field 'Item.stats'
        db.delete_column('invapp_item', 'stats')

        # Deleting field 'Project.stats'
        db.delete_column('invapp_project', 'stats')
