...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bag.payload'
        db.add_column('invapp_bag', 'payload',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Bag.stats'
        db.add_column('invapp_bag', 'stats',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bag.payload'
        db.delete_column('invapp_bag', 'payload')

        # Deleting field 'Bag.stats'
        db.delete_column('invapp_bag', 'stats')
