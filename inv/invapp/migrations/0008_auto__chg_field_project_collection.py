...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Project.collection'
        raise RuntimeError("Cannot reverse this migration. 'Project.collection' and its values cannot be restored.")
