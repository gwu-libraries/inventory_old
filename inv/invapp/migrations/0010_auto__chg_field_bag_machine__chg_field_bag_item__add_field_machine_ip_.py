...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bag.machine'
        db.alter_column('invapp_bag', 'machine_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['invapp.Machine']))

        # Changing field 'Bag.item'
        db.alter_column('invapp_bag', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['invapp.Item']))
        # Adding field 'Machine.ip'
        db.add_column('invapp_machine', 'ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=None, max_length=15, unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Item.collection'
        db.alter_column('invapp_item', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['invapp.Collection'], null=True))

        # Changing field 'Item.project'
        db.alter_column('invapp_item', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['invapp.Project'], null=True))

        # Changing field 'Project.collection'
        db.alter_column('invapp_project', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['invapp.Collection']))

    def backwards(self, orm):

        # Changing field 'Bag.machine'
        db.alter_column('invapp_bag', 'machine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invapp.Machine']))

        # Changing field 'Bag.item'
        db.alter_column('invapp_bag', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invapp.Item']))
        # Deleting field 'Machine.ip'
        db.delete_column('invapp_machine', 'ip')


        # Changing field 'Item.collection'
        db.alter_column('invapp_item', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['invapp.Collection']))

        # Changing field 'Item.project'
        db.alter_column('invapp_item', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['invapp.Project']))

        # Changing field 'Project.collection'
        db.alter_column('invapp_project', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['invapp.Collection']))
