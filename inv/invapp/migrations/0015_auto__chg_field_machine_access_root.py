...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Machine.access_root'
        db.alter_column(u'invapp_machine', 'access_root', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Machine.access_root'
        db.alter_column(u'invapp_machine', 'access_root', self.gf('django.db.models.fields.FilePathField')(max_length=100))
    ...
    models = {
        ...
        u'invapp.machine': {
            ...
            'access_root': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
