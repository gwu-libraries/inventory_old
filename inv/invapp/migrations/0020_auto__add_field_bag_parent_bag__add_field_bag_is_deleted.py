...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bag.parent_bag'
        db.add_column(u'invapp_bag', 'parent_bag',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_bags', null=True, on_delete=models.PROTECT, to=orm['invapp.Bag']),
                      keep_default=False)

        # Adding field 'Bag.is_deleted'
        db.add_column(u'invapp_bag', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bag.parent_bag'
        db.delete_column(u'invapp_bag', 'parent_bag_id')

        # Deleting field 'Bag.is_deleted'
        db.delete_column(u'invapp_bag', 'is_deleted')
    ...
    models = {
        u'invapp.bag': {
            ...
            'parent_bag': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_bags'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['invapp.Bag']"}),
