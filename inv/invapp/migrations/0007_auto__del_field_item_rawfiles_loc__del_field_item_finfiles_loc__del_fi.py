...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.rawfiles_loc'
        db.delete_column('invapp_item', 'rawfiles_loc')

        # Deleting field 'Item.finfiles_loc'
        db.delete_column('invapp_item', 'finfiles_loc')

        # Deleting field 'Item.ocrfiles_loc'
        db.delete_column('invapp_item', 'ocrfiles_loc')

        # Deleting field 'Item.qcfiles_loc'
        db.delete_column('invapp_item', 'qcfiles_loc')

        # Deleting field 'Item.qafiles_loc'
        db.delete_column('invapp_item', 'qafiles_loc')


    def backwards(self, orm):
        # Adding field 'Item.rawfiles_loc'
        db.add_column('invapp_item', 'rawfiles_loc',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Item.finfiles_loc'
        db.add_column('invapp_item', 'finfiles_loc',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Item.ocrfiles_loc'
        db.add_column('invapp_item', 'ocrfiles_loc',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Item.qcfiles_loc'
        db.add_column('invapp_item', 'qcfiles_loc',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Item.qafiles_loc'
        db.add_column('invapp_item', 'qafiles_loc',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)
