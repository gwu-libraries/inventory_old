...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.rename_column('invapp_machine', 'access_root', 'www_root')
        db.rename_column('invapp_bag', 'path', 'absolute_filesystem_path')

    def backwards(self, orm):
        db.rename_column('invapp_machine', 'www_root', 'access_root')
        db.rename_column('invapp_bag', 'absolute_filesystem_path', 'path')
